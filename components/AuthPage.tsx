        ...
        <div className="max-w-sm w-full mx-auto">
          ...
          <div className="mb-8">
            <button 
              ...
              className="w-full bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-800 text-zinc-700 dark:text-zinc-300 h-12 text-xs font-bold flex items-center justify-center gap-3 hover:bg-zinc-50 dark:hover:bg-zinc-800 hover:text-black dark:hover:text-white transition-all uppercase tracking-wider shadow-sm dark:shadow-none group relative overflow-hidden"
            >
              {googleLoading ? (
                <Loader2 className="h-4 w-4 animate-spin" />
              ) : (
                <>
                  <img src="https://www.svgrepo.com/show/475656/google-color.svg" className="w-4 h-4 grayscale group-hover:grayscale-0 transition-all duration-300" alt="G" />
